              ...
              <tr key={cls.id} className="hover:bg-stone-50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <select
                    ...
                    className="rounded-lg border border-stone-300 bg-white px-3 py-2 text-sm text-stone-800 shadow-sm focus:border-[#F97316] focus:outline-none focus:ring-1 focus:ring-[#F97316] disabled:opacity-50"
                  >
