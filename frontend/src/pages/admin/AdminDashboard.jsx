  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm border-l-4 border-l-[#4A2E2B]">
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm border-l-4 border-l-[#F97316]">
          <p className="text-xs uppercase font-bold text-stone-400">
            Assigned Teachers
          </p>
          <p className="text-3xl font-extrabold text-[#361F1D] mt-2">3</p>
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm border-l-4 border-l-emerald-600">
          <p className="text-xs uppercase font-bold text-stone-400">
            System Status
          </p>
